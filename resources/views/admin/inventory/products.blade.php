            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <form  method="GET">
                    ...
                    <div class="form-group mb-0 mt-2">
                        ...
                        @if (isset($_GET['q']))
                        <a href="{{isset($reset_link)? $reset_link : route('fetch_inventoryproducts')}}" class="btn btn-sm btn-dark">Clear</a>
                            ...
                            @if (!empty($fetchdata))
                                ...
                                @foreach ($fetchdata as $user)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('manage_inventory',['id'=>$user->id])}}" class="btn btn-sm btn-warning">Select</a>
