...
<div class="layout-px-spacing">
    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <a class="btn btn-primary  mb-2 mr-2" href="{{route('fetch_inventoryproducts')}}" style="float: right">Add Inventory</a>
        </div>
        @if ($errors->any())
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <form  method="GET">
                    ...
                    <div class="form-group mb-0 mt-2">
                        ...
                        @if (isset($_GET['q']))
                        <a href="{{isset($reset_link)? $reset_link : route('fetch_inventory')}}" class="btn btn-sm btn-dark">Clear</a>
                            ...
                            @if (!empty($fetchdata))
                                ...
                                @foreach ($fetchdata as $user)
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge badge-dark">{{$user->product?$user->product->id:0}}<span></td>
                                        <td>
                                            <div class="user-img">
                                        ...
                                        <td>{{$user->product->name}} {{$user->product->net_wt.' '.$user->product->unit}}</td>
                                        <td>{{$user->stock}}</td>
                                        <td>{{$user->comment}}</td>
