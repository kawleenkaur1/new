...
<div class="layout-px-spacing">
        ...
        <div class="row layout-top-spacing">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="header">
                                <div class="header-body">
                                    ...
                                    <p class="meta-date">till {{date('M Y')}}</p>
                                </div>
                            ...
                            <div class="w-content">
                                <div class="">
                                    <p class="task-left">{{$total_customers}}</p>
                                    <p class="task-completed"><span>Total Customers</span></p>
                                    <p class="task-hight-priority"><span>{{$new_customers.' new'}}</span> Customer added Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{route('fetch_categories')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    <p class="task-left">{{$total_categories}}</p>
                                    <p class="task-completed"><span>Total Categories</span></p>
                                    <p class="task-hight-priority"><span>{{$new_categories.' new'}}</span> Categories added Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{route('fetch_products')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    <p class="task-left">{{$total_products}}</p>
                                    <p class="task-completed"><span>Total Products</span></p>
                                    <p class="task-hight-priority"><span>{{$new_products.' new'}}</span> Product added Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{route('fetch_orders')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    <p class="task-left">{{$total_orders}}</p>
                                    <p class="task-completed"><span>Total Orders</span></p>
                                    <p class="task-hight-priority"><span>{{$new_orders.' new'}}</span> Order added Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <a href="{{route('fetch_completedorders')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    <p class="task-left">{{$total_complete_orders}}</p>
                                    <p class="task-completed"><span>Total Complete Orders</span></p>
                                    <p class="task-hight-priority"><span>{{$total_new_complete.' '}}</span> Order completed Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <a href="{{route('fetch_cancelledorders')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    <p class="task-left">{{$total_cancel_orders}}</p>
                                    <p class="task-completed"><span>Total Cancelled Orders</span></p>
                                    <p class="task-hight-priority"><span>{{$total_new_cancel.' '}}</span> Order cancelled Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {{-- <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <a href="{{route('fetch_subscriptions')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    <p class="task-left">{{$total_subscriptions}}</p>
                                    <p class="task-completed"><span>Total Subscriptions</span></p>
                                    <p class="task-hight-priority"><span>{{$new_subscriptions.' new'}}</span> Subscription added Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="widget-one">
                <div class="widget-content">
                    <div class="w-numeric-value">
                        ...
                        <div class="w-content">
                            <span class="w-value">{{$total_customers}}</span>
                            <span class="w-numeric-title">Total Customers</span>
                        </div>
                    </div>
                    <div class="w-chart">
                ...
                <div class="widget-content">
                    ...
                    <div class="w-content">
                        <div class="">
                            <p class="task-left">{{$total_customers}}</p>
                            <p class="task-completed"><span>Total Customers</span></p>
                            <p class="task-hight-priority"><span>{{$new_customers.' new'}}</span> Customers added Today</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            ...
            <div class="widget widget-five">
                <div class="widget-content">
                    ...
                    <div class="w-content">
                        <div class="">
                            <p class="task-left">{{$total_owners}}</p>
                            <p class="task-completed"><span>Total Owners</span></p>
                            <p class="task-hight-priority"><span>{{$new_owners.' new'}}</span> Owners added Today</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            ...
            <div class="widget widget-five">
                <div class="widget-content">
                    ...
                    <div class="w-content">
                        <div class="">
                            <p class="task-left">{{$total_enquiries}}</p>
                            <p class="task-completed"><span>Total Owners</span></p>
                            <p class="task-hight-priority"><span>{{$new_enquiries.' new'}}</span> Enquiries added Today</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            ...
            <div class="widget widget-five">
                <div class="widget-content">
                    ...
                    <div class="w-content">
                        <div class="">
                            <p class="task-left">{{$total_vehicles}}</p>
                            <p class="task-completed"><span>Total Vehicles</span></p>
                            <p class="task-hight-priority"><span>{{$new_vehicles.' new'}}</span> Vehicles added Today</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="widget-content">
                    ...
                    <div class="w-content">
                        <div class="">
                            <p class="task-left">{{$total_subscriptions}}</p>
                            <p class="task-completed"><span>Total Subscriptions</span></p>
                            <p class="task-hight-priority"><span>{{$new_subscriptions.' new'}}</span> Subscriptions added Today</p>
                        </div>
                    </div>
                </div>
            </div>
