{{-- <div class="row"> --}}
    <div id="flFormsGrid" class="col-lg-12 layout-spacing">
        <div class="widget-content widget-content-area">
            <form method="POST" action="{{isset($user) ? route('update_deliveryboy',['id'=>$user->id]) : route('save_deliveryboy')}}" enctype="multipart/form-data">
                            ...
                            <select name="warehouse_id" class="form-control" required>
                                ...
                                @if (!empty($warehouses))
                                    @foreach ($warehouses as $c)
                                        @if (isset($user))
                                            <?php $selected = $c->id == $user->warehouse_id ? 'selected':''; ?>
                                        @else
                                        <?php $selected =  ''; ?>
                                        @endif
