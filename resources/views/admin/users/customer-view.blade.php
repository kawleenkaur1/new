        ...
        <div class="user-profile layout-spacing">
            <div class="widget-content widget-content-area">
                ...
                <div class="text-center user-info">
                    <img style="width:150px" src="{{$user->image_url ? $user->image_url : asset('public/lib/assets/img/profile-3.jpg')}}" alt="avatar">
                ...
                <div class="user-info-list">
                    ...
                    <div class="">
                        <ul class="contacts-block list-unstyled">
                            ...
                            @if ($address)
                            {{$address->flat.' '.$address->main_society.' '.$address->main_location}}
                            @else
