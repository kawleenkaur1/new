...
<div class="layout-px-spacing">
    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <a class="btn btn-primary  mb-2 mr-2"  style="float: right" href="{{route('add_society')}}">Add Society</a>
        </div>
        @if ($errors->any())
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <form  method="GET">
                    ...
                    <div class="form-group mb-0 mt-2">
                        ...
                        @if (isset($_GET['q']))
                        <a href="{{route('fetch_societys')}}" class="btn btn-sm btn-dark">Clear</a>
                        @endif
                ...
                <div class="table-responsive mb-4 mt-4">
                    <table class="table table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <div id="add_society" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                    <!-- Modal content-->
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Add society</h5>
                            ...
                            <?php  $count =(($fetchdata->currentpage()-1)* $fetchdata->perpage() + 1); ?>
                                @foreach ($fetchdata as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $url_ct = route('load_society_data',['id'=>$item->id]);
                                                ?>
                                            <a class="btn btn-sm btn-primary mb-2 mr-2" href="{{route('update_society',['id'=>$item->id])}}">
                                                Edit</a>
                                            <a class="btn btn-sm btn-danger mb-2 mr-2" onclick="return confirm('Are you sure ?')" href="{{route('delete_society',['id'=>$item->id])}}">
                                                Delete</a>
