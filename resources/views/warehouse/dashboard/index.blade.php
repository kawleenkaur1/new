...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
       ...
       <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <a href="{{route('fetch_deliveryboyswarehouse')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    <p class="task-left">{{$total_deliveryboy}}</p>
                                    <p class="task-completed"><span>Total Delivery Boy</span></p>
                                    <p class="task-hight-priority"><span>{{$new_deliveryboy.' new'}}</span> Delivery Boy  Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <a href="{{route('fetch_buyonce_orderswarehouse')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    ...
                                    <p class="task-hight-priority"><span>{{$new_orders.' new'}}</span> Order Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <a href="{{route('fetch_pending_orderswarehouse')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    <p class="task-left">{{$total_onging_orders}}</p>
                                    <p class="task-completed"><span>Total Ongoing Orders</span></p>
                                    <p class="task-hight-priority"><span>{{$new_onging_orders.' new'}}</span> Order Ongoing Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <a href="{{route('fetch_completedorderswarehouse')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    ...
                                    <p class="task-hight-priority"><span>{{$new_complete_orders.' new'}}</span> Order Complete Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                <a href="{{route('fetch_cancelledorderswarehouse')}}">
                    <div class="widget widget-five">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                <div class="">
                                    <p class="task-left">{{$total_cancelled_orders}}</p>
                                    <p class="task-completed"><span>Total Cancelled Orders</span></p>
                                    <p class="task-hight-priority"><span>{{$new_cancelled_orders.' new'}}</span> Order Cancelled Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
