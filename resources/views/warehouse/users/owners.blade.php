...
<div class="layout-px-spacing">
    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <a class="btn btn-primary  mb-2 mr-2" href="{{route('add_owner')}}" style="float: right">Add Owner</a>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-9 filtered-list-search mx-auto">
                            <form method="GET" class="form-inline my-2 my-lg-0 justify-content-center">
                                <div class="w-100">
                                    <input value="<?=isset($_GET['q']) ? $_GET['q'] : '' ?>" type="text" name="q" class="w-100 form-control product-search br-30" id="input-search" placeholder="Search Owner..." >
                ...
                <form  method="GET">
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="form-group mb-0 mt-2">
                            ...
                            <a href="{{route('fetch_owners')}}" class="btn btn-sm btn-dark">Reset</a>
                                ...
                                @foreach ($users as $user)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            View</button>
                                            <a href="{{route('edit_owner',['id'=>$user->id])}}" class="btn btn-sm btn-dark">Edit</a>
