...
<!-- Mirrored from designreset.com/cork/ltr/demo3/auth_login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 May 2020 09:51:38 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <title>Login | KATLEGO </title>
    ...
    <link href="{{ asset('public/lib/assets/css/authentication/form-2.css') }}" rel="stylesheet" type="text/css" />
...
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Warehouse Sign In</h1>
                        <p class="">Log in to your account to continue.</p>
                        @include('admin.partials.flash')

                        <form class="text-left" action="{{route('warehouse_login_request')}}">
                            <div class="form">

                                <div id="username-field" class="field-wrapper input">
                                    <label for="username">USERNAME</label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <input id="username" name="email" type="text" value="{{old('email')}}" class="form-control" placeholder="e.g admin@gmail.com">
                                </div>
                                @csrf
    ...
    <script src="{{ asset('public/lib/assets/js/authentication/form-1.js') }}"></script>
